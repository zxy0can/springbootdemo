		...
		<div class="layui-fluid">
			<div class="layui-row layui-col-space15">
				<div class="layui-col-sm12 layui-col-md12 zyl_mar_01">
					<blockquote class="layui-elem-quote">进销存系统·登陆界面</blockquote>
				</div>
			</div>
		</div>
		<!-- Head End -->
				...
				<form class="layui-form zyl_pad_01" action="">
					<div class="layui-col-sm12 layui-col-md12">
						<div class="layui-form-item">
							<input type="text" name="employeenumber" lay-verify="required|employeenumber" autocomplete="off" placeholder="账号" class="layui-input">
		...
		<script>
			layui.use(['carousel', 'form'], function(){
				...
				$.ajax({
					url:"user/login",
					type:"post",
					data:{"employeenumber":data.field.employeenumber,"password":data.field.password},
					dataType:"text",
					success:function (data1) {
					    if(data1=="true"){
                          window.location.href='user/toBackIndex';
						}else  layer.alert("false")
                    }
				})
                    return false;
				});
